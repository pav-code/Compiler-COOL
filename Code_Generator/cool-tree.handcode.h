...
virtual void dump_with_types(ostream&,int) = 0;                \
virtual Symbol get_disp() = 0;                                  \
virtual Symbol get_proto() = 0;                                  \
virtual Symbol get_name() = 0;                                    \
...
#define attr_EXTRAS                                \
Symbol get_disp()    { return NULL; }               \
Symbol get_proto()   { return type_decl; }           \
Expression get_init() { return init; }                \
Expression get_expr() { return NULL; }                 \
Formals get_formals() { return NULL; }

#define method_EXTRAS                              \
Symbol get_disp()    { return name; }               \
Symbol get_proto()   { return NULL; }                \
...
virtual void code(ostream&, pCon) = 0;


#define branch_EXTRAS                               \
void dump_with_types(ostream& ,int);                 \
Symbol get_type() { return type_decl; }               \
void code( ostream&, pCon ); 
